...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        for m in self.message_text:
            if m==' ':
                mes+=m
            elif m not in c and m not in d:
                m=dic[m]
                mes+=m
            else:
                mes+=m
...
#added to decript a story
def decrypt_story():
    text=get_story_string()
    ex=CiphertextMessage(text)
    return ex.decrypt_message()
